...
[![Goose
CI](https://github.com/fmarmol/goose/actions/workflows/ci.yaml/badge.svg)](https://github.com/fmarmol/goose/actions/workflows/ci.yaml)
[![Go
Reference](https://pkg.go.dev/badge/github.com/fmarmol/goose/v3.svg)](https://pkg.go.dev/github.com/fmarmol/goose/v3)
[![Go Report
Card](https://goreportcard.com/badge/github.com/fmarmol/goose/v3)](https://goreportcard.com/report/github.com/fmarmol/goose/v3)
...
```shell
go install github.com/fmarmol/goose/v3/cmd/goose@latest
```
...
See [installation documentation](https://fmarmol.github.io/goose/installation/) for more details.
...
variables](https://fmarmol.github.io/goose/documentation/environment-variables/).
...
2. Import `github.com/fmarmol/goose`
...
problem](https://github.com/fmarmol/goose/issues/63#issuecomment-428681694) first.
